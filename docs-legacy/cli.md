> 目前专注于服务 API 化， cli 可能会被完全废弃，所以这里先鸽了。
...
```shell
xnnehanglab➜  XnneHangLab git:(audio-length-in-vad-fastapi) uv run acgo vad -i examples/example3.opus 
 任务  VAD 语音活动检测
funasr version: 1.2.6.
rtf_avg: 0.013: 100%|██████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 1/1 [00:00<00:00, 10.83it/s]
 INFO  {'key': 'example3', 'timestamp': [[680, 7020]], 'audio_length': 7046}
```
