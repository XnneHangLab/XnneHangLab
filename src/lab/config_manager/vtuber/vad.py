...
class SileroVADConfig(I18nMixin):
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "prob_threshold": Description(en="Probability Threshold for VAD", zh="语音活动检测的概率阈值"),
        "db_threshold": Description(en="Decibel Threshold for VAD", zh="语音活动检测的分贝阈值"),
        ...
        "smoothing_window": Description(en="Smoothing window size for VAD", zh="语音活动检测的平滑窗口大小"),
    }
...
class VADConfig(I18nMixin):
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        "vad_model": Description(en="Voice Activity Detection model to use", zh="要使用的语音活动检测模型"),
