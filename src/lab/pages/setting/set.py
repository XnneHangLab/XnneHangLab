    ...
    with col2:
        ...
        if st.button("**保存更改**", type="primary", use_container_width=True):
            ...
            if current_settings != initial_settings:  # Compare dictionaries
                ...
                settings.custom_output_dir = custom_output_dir if custom_output_dir else initial_settings["basic"]["custom_output_dir"]
                ...
                settings.hot_words_path = hot_words_path if hot_words_path else initial_settings["paths"]["hot_words_path"]
