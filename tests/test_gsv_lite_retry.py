...
def test_apply_gsv_lite_monkey_patch_repairs_japanese_g2p(monkeypatch) -> None:
    ...
    japanese_impl_module.JapaneseG2P = FakeJapaneseG2P
...
def test_synthesize_once_retries_with_normalized_japanese_text(monkeypatch) -> None:
...
def test_synthesize_once_retries_by_splitting_long_text(monkeypatch) -> None:
    captured_texts: list[str] = []
