#!/usr/bin/env python3
"""Tests for export_schema_node.py CSV/JSON parsing logic."""
...
SCRIPT_PATH = Path(__file__).parent.parent / "scripts" / "export_schema_node.py"

spec = importlib.util.spec_from_file_location("export_schema_node", SCRIPT_PATH)
